...
@php
    $target = $target ? 'wire:target=' . $target . '' : '';
@endphp

<div class="hidden" wire:loading.block {{ $target }}>
    ...
    <div class="absolute w-full h-full -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 bg-gray-100 opacity-50">
        &nbsp;
    </div>
</div>
